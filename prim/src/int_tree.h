...
class IntTree{
  ...
  class Node{
    ...
    public:
      ...
      Node(const double e, const uint i, const uint j):e_(e), i_(i), j_(j), W_(-1){};
      ...
      Node(const double e, const uint i, const uint j, const double W):e_(e), i_(i), j_(j), W_(W){};
